        ...
        return (
          <div key={r.label}>
            ...
            >
              ...
              <div className="w-32 shrink-0 text-right text-xs tabular-nums text-ink-400">{formatMoney(r.sum)}</div>
            </button>
                ...
                {r.items.length === 0 ? (
                  ...
                  r.items.map((d) => (
                    ...
                    >
                      ...
                      <span className="w-28 shrink-0 text-right font-mono text-sm text-ink-100">{formatMoney(d.amount)}</span>
                    </Link>
                  ))
                )}
              </div>
