...
2. **ИИ-кнопки в карточках** (1A): «Саммари клиента за месяц», «Драфт ДС по шаблону». Нужен ИИ-ключ.
3. **Внутренний мессенджер** (2): каналы/личка, вложения, закреплённые сообщения, привязка к клиенту/сделке.
