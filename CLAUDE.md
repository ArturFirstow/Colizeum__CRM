...
4. ✅ ИИ-чат ассистент (1B) `/assistant`: чат с инструментами (`aiChat` в `ai.ts` — tool-loop; `/api/ai/chat`; инструменты list_my_clients/get_client/search_knowledge со скоупом сотрудника). Общий пункт меню.
